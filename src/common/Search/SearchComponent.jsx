...
const Searchcomponent = () => {
  return (
    <div className='flex justify-end items-center mb-3 w-96 md:w-[22%]'> 
        ...
        <input type="search" id="search" className="block border-2 border-violet-700 focus:border-violet-500 dark:focus:border-violet-500 bg-gray-50 dark:bg-violet-950 p-4 rounded-lg w-full h-14 text-gray-900 text-sm dark:text-violet-200 ps-10 focus:ring-violet-500 dark:placeholder-violet-200 dark:focus:ring-blue-500" placeholder="جستجو" required />
