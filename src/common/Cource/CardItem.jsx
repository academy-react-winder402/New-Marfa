...
export const CardItem = ({
  ...
  return (
    <div className="relative w-full group">
      ...
      <div
        className={`absolute left-[-16px] top-[-1px] z-20 w-0 cursor-pointer overflow-hidden rounded-br-lg rounded-tr-lg bg-blue-400 py-2 group-hover:w-14 group-hover:pr-2 group-hover:duration-500 dark:shadow-lg dark:shadow-violet-600`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
