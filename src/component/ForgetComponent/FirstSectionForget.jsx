...
const FirstSectionForget = ({ description, setCount }) => {
  ...
  return (
    <div className="w-full dark:bg-violet-950 dark:text-violet-200">
      <div className="text-right mt-4 mr-7 w-full text-[#A193FF] text-nowrap">
        {" "}
        {description}
      </div>
      <Formik initialValues={{ email: "" }} onSubmit={handleSubmit}>
        <Form className="">
          ...
          <div className="mt-4 mr-6 w-[80%]">
            <button
              className="flex justify-center bg-gradient-to-r from-[#7b2aff] to-[#4545ff] mx-auto mb-5 py-4 md:py-6 rounded-lg w-[60%] font-bold text-center text-nowrap text-sm text-white md:text-lg"
              type="submit"
            >
              {" "}
      ...
      <div className="flex justify-around items-center mx-auto pb-1 w-[80%] md:w-[90%] 2xl:max-w-2xl text-[#3F40EA] text-center">
        <div className="flex justify-center items-center border-[#A193FF] border-4 rounded-full w-[41px] h-[41px]">
          3
        </div>
        ...
        <div className="flex justify-center items-center border-[#8735F5] border-4 bg-[#8735F5] rounded-full w-[41px] h-[41px]">
          ...
          >
            <path
              d="M5.31066 9.56434C4.72487 8.97855 3.77513 8.97855 3.18934 9.56434C2.60355 10.1501 2.60355 11.0999 3.18934 11.6857L5.31066 9.56434ZM9.25 15.625L8.18934 16.6857C8.50711 17.0034 8.9506 17.162 9.39781 17.1177C9.84501 17.0734 10.2488 16.831 10.4981 16.4571L9.25 15.625ZM17.9981 5.20705C18.4576 4.51776 18.2713 3.58645 17.5821 3.12692C16.8928 2.6674 15.9615 2.85366 15.5019 3.54295L17.9981 5.20705ZM3.18934 11.6857L8.18934 16.6857L10.3107 14.5643L5.31066 9.56434L3.18934 11.6857ZM10.4981 16.4571L17.9981 5.20705L15.5019 3.54295L8.00192 14.7929L10.4981 16.4571Z"
              fill="white"
            />
          </svg>
        </div>
      ...
      <div className="flex justify-between items-center mx-auto pb-4 w-[80%] md:w-[90%] 2xl:max-w-2xl text-[12px] text-center">
        <div className="text-[#A193FF] text-nowrap dark:text-violet-200">
          تغییر رمز عبور{" "}
        </div>
...
export default FirstSectionForget;
