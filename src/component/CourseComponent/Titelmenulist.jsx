...
const Titelmenulist = ({showType, setShowType ,handleSearch }) => {
  ...
  return (
      ...
      <div className='flex flex-row md:flex-row flex-wrap lg:flex-nowrap justify-center items-center gap-8 m-12 mx-auto px-12 w-[80%]'>
       ...
       <div className='rtl:text-right float-left flex justify-between items-center gap-3 border-violet-100 bg-gray-50 hover:bg-gray-100 dark:bg-violet-950 mx-auto px-5 py-5 p-5 border border-b rounded-2xl rounded-t-xl w-full md:w-full lg:w-96 h-14 font-medium text-gray-500 text-nowrap focus:ring-2 focus:ring-violet-200 dark:text-violet-200'  id="accordion-open-heading-1">
       ...
       <DropdownComponent/>
        ...
        {/* end acardion 1 */}
        <div className='bg-gray-50 rounded-2xl rounded-t-xl w-52 text-red-700'>
