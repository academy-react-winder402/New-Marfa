...
const Titelmenulist = ({handleSearch}) => {
  return (
      ...
      <div className='flex flex-row md:flex-row flex-wrap lg:flex-nowrap justify-center items-center gap-8 m-12 mx-auto px-12 w-[85%]'>
        <div  className='float-right flex flex-row justify-center items-center gap-2 md:gap-2 border-4 border-violet-100 dark:hover:bg-violet-800 hover:bg-gray-50 pr-1 rounded-2xl md:rounded-2xl w-48 md:w-52 h-14 text-lg dark:text-violet-200 focus:outline-none focus:ring-2 text-nowrap md:text-sm'>
        <span > فیلتر ها</span>
        ...
        <div id="accordion-open" data-accordion="open">
          <div className='float-left w-52 lg:w-96'  id="accordion-open-heading-1">
            <button type="button" className="rtl:text-right flex justify-between items-center gap-3 border-violet-100 bg-gray-50 hover:bg-gray-100 dark:hover:bg-violet-800 dark:bg-violet-950 px-5 py-5 p-5 border border-b rounded-2xl rounded-t-xl w-full md:w-full h-14 font-medium text-gray-500 text-nowrap dark:text-violet-200 focus:ring-2 focus:ring-violet-200" data-accordion-target="#accordion-flush-body-1" aria-expanded="true" aria-controls="accordion-flush-body-1">
