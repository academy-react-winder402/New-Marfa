...
const License = () => {
       ...
       const display = location.pathname=='/login/register' ? `invisible` : `visible`;
    return ( 
        <>
         <div className={`text-white bg-violec h-12  py-3 w-full text-center flex flex-row gap-2 justify-center ${display} `}>
   
         <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 122.88"  xml:space="preserve" className="w-5 h-5" fill="white"><g>
         ...
         تمامی حقوق این سایت متعلق به تیم مارفا می باشد.
