...
return (
  ...
  <div className="flex justify-center items-center px-4  h-24 text-nowrap ">
    ...
    <ul className={`sm:flex sm:flex-row sm:flex-grow sm:items-center sm:gap-10 hidden  ${textColor}`}>
      <li className={` ${displayMENU}`} ><Link to="/"> صفحه اصلی</Link></li>
      <li className="p-4"><Link to="/courses">دوره ها</Link></li>
      {/* <li className="p-4"><Link to="/">اساتید</Link></li> */}
      <li className=""><Link to="/news">  اخبار و مقالات </Link></li>
    ...
    <ul className={`p-4 ${textColorHambergerMenu}`}>
      <li className={`p-4 ${displayMENU}`}><Link to="/"> صفحه اصلی</Link></li>
      <li className="hover:shadow-lg p-4"><Link to="/courses">دوره ها</Link></li>
      <li className="hover:shadow-lg p-4"><Link to="/news">اخبار و مقالات</Link></li>
    </ul>
    </div>
  </div>
