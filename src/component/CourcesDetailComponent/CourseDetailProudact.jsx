...
const CourseDetailProudact = () => {
  return (
    <div className='flex flex-col justify-start items-center dark:border-2 dark:border-violet-700 dark:bg-violet-950 -mt-10 py-10 rounded-lg md:w-full h-auto'>
        ...
        <div className='flex flex-col justify-between items-center border-[#3D00B1]/20 dark: border-indigo-600 border-b-2 divide-y divide-[#3D00B1]/20 dark:divide-indigo-600 w-[90%]'>
           <div className='flex flex-row justify-between items-center w-[100%] h-20'>
               <div className='flex items-center gap-2'>
                ...
                <h6 className='text-[#2C007F] dark:text-violet-200'>28 </h6>
            </div> 
            <div className='flex flex-row justify-between items-center w-[100%] h-20 ny-3'>
              <div className='flex items-center gap-2'>
                ...
                <h6 className='text-[#2C007F] dark:text-violet-200'>در حال برگزاری </h6>
            </div>
            <div className='flex flex-row justify-between items-center w-[100%] h-20 ny-3'>
             <div className='flex items-center gap-2'>
                ...
                <h6 className='text-[#2C007F] dark:text-violet-200'>1403/01/25 </h6>
            </div>
            <div className='flex flex-row justify-between items-center w-[100%] h-20 bo ny-3'>
              <div className='flex items-center gap-2'>
                ...
                <h6 className='text-[#2C007F] dark:text-violet-200'>1403/06/26 </h6>
            </div>
            
        </div> 
        <div className='mt-12 w-96 md:w-64 lg:w-72'><h5 className='flex justify-center items-center border-2 border-indigo-600 mt-5 rounded-lg h-16 dark:text-violet-200'>قیمت: 400000 تومان </h5></div>
