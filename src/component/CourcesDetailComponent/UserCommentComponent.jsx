       ...
       <div className='w-full'>
        <Formik>
            <Form className="m-5 mx-auto max-w-sm md:max-w-full dark:text-violet-200 leading-5">
                ...
                <textarea id="message" rows="4" className="block border-[#9293FF] border-2 dark:border-indigo-600 bg-gray-50 dark:bg-violet-900 p-2.5 focus:border-blue-500 dark:focus:border-blue-500 rounded-lg w-full text-gray-900 text-sm focus:ring-blue-500 dark:text-white dark:placeholder-gray-400 dark:focus:ring-blue-500" placeholder="پیام خود را وارد کنید..."></textarea>
            </Form>
        </Formik>
