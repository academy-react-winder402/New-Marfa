...
// Return Section
    ...
    <>
           <div className="w-full">
            <div className="w-full text-right mt-4 md:mt-2 mr-7 text-[#A193FF] text-nowrap "> ایمیل و کلمه رمز خود را وارد کنید</div>
            <Formik initialValues={{gmail:'',password:'',phoneNumber:phoneNumber}} onSubmit={handleSubmit}>
                <Form className="">
                    <div className="w-full mt-3 flex flex-col"> 
                         <div className="w-[80%] flex flex-col" >
                            ...
                            type='email' name='gmail' placeholder='   gmail  خود را وارد کنید '/>
                           </div>                    
                            ...
                            <div className="flex flex-col w-[80%] " >
                                ...
                                type={showPassword ? "text" : "password"} name='password' placeholder='   password  خود را وارد کنید '/>
                                {!showPassword && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                                stroke-width="1.5" stroke="#7b2aff" 
                                className="relative bottom-12 -left-4 flex mr-auto w-5 h-5" onClick={() => setShowPassword(!showPassword)} >
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88" />
                                </svg>}
                                { showPassword &&  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                                stroke-width="1.5" stroke="#7b2aff" className="relative bottom-12 -left-4 flex mr-auto w-5 h-5" 
                    ...
                    <div className="w-[80%] mr-6 mt-4 md:mt-2">
                        ...
                        text-white " type="submit" >   ارسال اطلاعات    </button>
                    </div>
                </Form>    
            </Formik>  
            <div className="flex flex-row justify-between w-[80%] md:w-[90%] text-center text-[16px] 
            md:text-[18px] mt-8 md:mt-4 mr-7 pb-8  text-[#A193FF] text-nowrap  ">
                <div className="text-[#4E447D] bg-[#E7E2FF] py-2 hover:bg-[#A193FF] px-4 rounded-md cursor-pointer" onClick={() => setCount(2)}>مرحله قبل</div>
            </div>
            ...
            <div className="flex w-[80%] md:w-[90%] pb-4 mx-auto justify-between items-center text-center text-[12px] 2xl:max-w-2xl">
                            <div className="  text-[#4E447D] text-nowrap">مشخصات کاربری</div>
                            <div className="   text-[#4E447D] text-nowrap" >دریافت کد</div>
