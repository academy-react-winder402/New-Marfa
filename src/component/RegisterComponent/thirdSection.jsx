    ...
    <>
           <div className="w-full">
                ...
                <Form className="">
                    <div className="w-full mt-3 flex flex-col">
                        ...
                        <div className="w-[80%] flex flex-col" >
                            ...
                            <Field id="password" className="w-full h-10 rounded-lg pr-3 my-4 border-2 border-[#a193ff] mr-6" type='text' name='password' placeholder='   کد  خود را وارد کنید '/>
                        </div>
                        <div className="w-[80%] flex flex-col" >
                            {/* <label for="email" className=" text-[16px] mr-6 text-nowrap my-1 "> شماره موبایل یا ایمیل </label> */}
                            
                            <Field id="gmail" className="w-full h-10 rounded-lg pr-3 my-4 border-2 border-[#a193ff] mr-6" type='text' name='gmail' placeholder='   کد  خود را وارد کنید '/>
                        </div>
            ...
            <div className="flex flex-row justify-between w-[80%] md:w-[90%] text-center text-[16px] md:text-[18px] mt-8 mr-7 pb-8 text-[#A193FF] text-nowrap  ">
                ...
                <div className="text-[#A193FF] bg-[#E7E2FF] py-2 px-4 rounded-md" onClick={() => setCount(2)}>مرحله قبل</div>
            </div>
