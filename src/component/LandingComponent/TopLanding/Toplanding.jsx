...
export const Toplanding = () => {
    return(
        <div className="relative flex h-96 w-full items-baseline justify-center md:h-[42rem]">
            ...
            <div className='md:text-xl'><span>پلتفرم آموزش طراحی وب</span></div>
            <div className='mt-6 md:mt-10'><h1 className='text-3xl md:text-6xl'>مرجع آموزش برنامه نویسی</h1></div>
            <div className='mt-6 text-wrap text-center text-lg leading-8 md:mt-10 md:text-3xl md:leading-[3.5rem]'><span>مرجع آموزش زنده و تعاملی دسترسی به بیش از هفت هزار ویدیوی آموزشی به زبان فارسی</span></div>
            

            <div className="absolute mt-52 w-full md:mt-80">
            <input type="text" id="search" className="custom-input pr-6 text-right md:top-80" placeholder="چه چیزی می خوای یاد بگیری..." />
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="absolute left-3 top-[1rem] h-6 w-6 text-indigo-700">
            <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
            </svg>

            </div>
            <div className='absolute hidden w-full flex-row justify-around md:top-96 md:block md:flex md:flex-row'> 
                <div className='flex-col'>
                    <img src={teacher} className='w-24' alt="" />
                    <span className='block text-center'>53254</span>                    
                    <span className='block text-center'>نفر دانشجو</span>
                </div>
                <div className='flex-col'>
                    <img src={learn} className='w-24' alt="" />
                    <span className='block text-center'>53254</span>                    
                    <span className='block text-center'>دقیقه آموزش </span>
                </div>
                <div className='flex-col'>
                    <img src={studdent} className='w-24' alt="" />
                    <span className='block text-center'>53254</span>                    
