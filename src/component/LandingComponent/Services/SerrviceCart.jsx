...
const ServiceCart = (props) => {
    return (
        <div className="hover:border-1 flex w-[95%] flex-row justify-around rounded-lg shadow-slate-300 transition-all hover:border-white hover:shadow-2xl md:flex-col">
