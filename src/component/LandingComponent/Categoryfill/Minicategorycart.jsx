...
const Minicategorycart = ({title,image,id}) => {
  ...
  return (
        <div className={`  dark:from-violet-900  dark:to-violet-700 relative z-50 bg-gradient-to-b from-[#6B3FEA] to-[#7070FF] hover:bg-[#EBE0FF] rounded-2xl rounded-bl-[5rem] w-[45%] lg:w-[18%] h-52 text-white hover:text-[#6D53F2] ${bg}`}>
