...
const NewsDetailTopComponent = () => {
  return (
   <div className='border-[#3F40EA]/20 bg-[#D7D5FF] w-full'>
     <div className='flex lg:flex-row flex-col justify-center items-center border-[#3F40EA]/20 mx-auto pt-5 pb-10 border-b-2 w-[90%]'>
      ...
      <div className='md:[50%] w-[90%] lg:w-[70%]'>
        <h1 className='p-5 text-[#3B3CA7] text-2xl'>چگونه مطالعه ی موثر را برای شما آسان تر کنیم</h1>
        <div className='flex p-5 text-[#8E8EAA]'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
            </svg>
           <h5>مارفا تک تیک</h5>
        </div>
        <h3 className='p-10 text-[#03001C]/50 text-2xl text-justify leading-10'>
